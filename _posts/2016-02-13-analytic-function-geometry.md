...
If $\left\|f\left(z_0\right)\right\| \ge \left\|f\left(z\right)\right\|$ for all $z \in \left\|z-z_0\right\| \lt r$, $r\gt0$ then $f\left(z_0\right)$ must be on the boundary of the set $W=\left\{f\left(z\right) \left\|\right z \in \left\|z-z_0\right\| \lt r\right\}$ but this contradicts the fact that $W$ is an open set.$\Box$
