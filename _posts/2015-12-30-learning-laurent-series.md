...
comments: true
---
As I have mentioned in a previous post, I am reading through Fisher's Complex Analysis during my lunch break at work. I am currently nearing the end of chapter two and reading about isolated singularities and a function's Laurent series.
...
1.  $\left|f(z)\right|$ remains bounded as $z \rightarrow z_0$.
2. $\lim_{z \rightarrow z_0} \left|f(z)\right| = \infty$
